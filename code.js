...
let citations = [
  ...
  // Variables
  let last = 0, randomIndex;

  // Functions
  function generateIntegerNumber(max) {
  ...
  function newCitation() {
    do {
      generateIntegerNumber(21);
    } while (randomIndex == last);

    citation.innerHTML = citations[randomIndex][0];
    author.innerHTML   = citations[randomIndex][1];
  }

  // Launch
  buttonNew.addEventListener('click', newCitation);
